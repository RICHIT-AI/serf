...
using `go get -u github.com/richit-ai/serf/cmd/serf`.
...
Next, clone this repository into `$GOPATH/src/github.com/richit-ai/serf` and
...
the command `go get -u github.com/richit-ai/serf/cmd/serf`.  Applications using
the Serf library should only need to include `github.com/richit-ai/serf`.
