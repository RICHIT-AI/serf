...
IMPROVEMENTS:
* ValidateNodeName flag can now restrict node names to alphanumeric, -, and . while also keeping node names under 128 characters. Verification of IP Address and tags occur for messages. [GH-612](https://github.com/richit-ai/serf/pull/612)
